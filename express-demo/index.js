...
app.post('/api/courses', (req, res) => {
    const schema = {    // ***We define JOI Schema for our object... a Schema defines the shape of our Object -> what type, props, etc we will use... 
    ...
    const result = Joi.validate(req.body, schema);   // We give JOI req.body as well as the schema we declared... 
    console.log(result);
